...
const UserLogin = () => {
  ...
  return (
    <main className="flex flex-col justify-center items-center h-screen w-full bg-black bg-[radial-gradient(circle_at_center,rgba(220,38,38,0.3),rgba(0,0,0,0.9))]">
      <style jsx global>{pulseRotateAnimation}</style>
      <style jsx global>{zoomAnimation}</style>
      <style jsx global>{loadingAnimation}</style>
      ...
      <div className="w-full max-w-6xl mx-auto px-4">
        <div className="bg-black/40 backdrop-blur-xl p-8 rounded-3xl border border-red-500/30 shadow-2xl w-full">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="text-sm text-red-400/70 font-mono">SQL SAGA v1.0</div>
          </div>
                ...
                <div className="bg-black/40 rounded-xl border border-red-500/20 p-6">
                  ...
                  <div className="mb-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-red-400 text-sm font-mono">SQL Query</span>
                    </div>
                  ...
                  {showProcessing && (
                    <div className="mb-4 animate-fade-in">
                      <div className="relative bg-black/80 rounded-lg p-5 overflow-hidden border border-red-500/30"
                        ...
                        <div className="relative h-5 bg-black/50 rounded-full overflow-hidden mb-2 border border-red-500/20">
                          <div 
                            style={{ 
                              height: '100%',
                              width: `${bufferPercent}%`,
                              backgroundImage: 'linear-gradient(to right, #b91c1c, #ef4444, #b91c1c)',
                          ...
                          <div className="absolute inset-0 flex items-center justify-center text-white/90 text-xs font-mono">
                            <span className="drop-shadow-[0_0_3px_rgba(0,0,0,0.9)]">{bufferPercent}% COMPLETE</span>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  {showResults && (
                    <div className="animate-fade-in">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-green-400 text-sm font-mono">Results</span>
                      </div>
                      <div className="bg-black/60 rounded-lg p-4">
                        <div className="font-mono text-sm">
                          <div className="text-white/90 mb-2">
                            <span className="text-green-400">Contest Details</span>
                          </div>
                          <div className="text-white/70 text-sm space-y-2">
                            <div className="grid grid-cols-2 gap-4">
                              <span className="text-green-300">Contest Name:</span>
                              <span>SQL Saga</span>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="mt-4 text-white/80">
                              ...
                              <p className="mt-1 text-sm">
                                A competitive SQL programming contest where participants solve complex database challenges. 
                                Test your SQL expertise, problem-solving skills, and optimization techniques in this 
                                exciting database showdown.
                              </p>
                            </div>
                          </div>
                        </div>
